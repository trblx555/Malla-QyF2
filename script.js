const ramos = [
  ...
  { id: 'internado', nombre: 'Internado en farmacia clínica', req: ['tec2', 'cosmetica', 'clinic', 'inv'] },
  { id: 'practica', nombre: 'Práctica prolongada', req: ['tec2', 'cosmetica', 'clinic', 'inv'] },
  { id: 'practica_com', nombre: 'Práctica obligatoria en farmacia comunitaria', req: [] },
  { id: 'seminario', nombre: 'Seminario de título', req: ['tec2', 'cosmetica', 'clinic', 'inv'] },
];
